...
public class Employees extends TableImpl<EmployeesRecord> {
     ...
     */
    public final TableField<EmployeesRecord, BigDecimal> ID =
            createField(DSL.name("id"), SQLDataType.NUMERIC.nullable(false), this, "");

    /**
     * The column <code>public.employees.name</code>.
     */
    public final TableField<EmployeesRecord, String> NAME =
            createField(DSL.name("name"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.employees.address</code>.
     */
    public final TableField<EmployeesRecord, String> ADDRESS =
            createField(DSL.name("address"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.employees.join_date</code>.
     */
    public final TableField<EmployeesRecord, OffsetDateTime> JOIN_DATE = createField(
            DSL.name("join_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
            Function4<? super BigDecimal, ? super String, ? super String, ? super OffsetDateTime, ? extends U> from) {
